function init_sidebar() {
    var e = function () {
        ...
        var e = $BODY.outerHeight(), a = $BODY.hasClass("footer_fixed") ? -10 : $FOOTER.height(), t = $LEFT_COL.eq(1).height() + $SIDEBAR_FOOTER.height(), n = e < t ? t : e;
...
function init_skycons() {
    if ("undefined" != typeof Skycons) {
        ...
        var e, a = new Skycons({color: "#73879C"}), t = ["clear-day", "clear-night", "partly-cloudy-day", "partly-cloudy-night", "cloudy", "rain", "sleet", "snow", "wind", "fog"];
...
function init_chart_doughnut() {
    if ("undefined" != typeof Chart && (console.log("init_chart_doughnut"), $(".canvasDoughnut").length)) {
        var e = {
            ...
            data: {
                labels: ["INSERT", "SELECT", "DELETE", "UPDATE"],
                datasets: [{
                    data: [((temp[0] * 100) / temp[4]).toFixed(2), ((temp[1] * 100) / temp[4]).toFixed(2), ((temp[2] * 100) / temp[4]).toFixed(2), ((temp[3] * 100) / temp[4]).toFixed(2)],
                    backgroundColor: ["#BDC3C7", "#9B59B6", "#3498DB", "#26B99A"],
                    hoverBackgroundColor: ["#BDC3C7", "#9B59B6", "#3498DB", "#26B99A"]
                }]
            },
...
function init_gauge() {
    if ("undefined" != typeof Gauge) {
        ...
        if ($("#gauge-text").length && (t.maxValue = 6e3, t.animationSpeed = 32, t.set(3200), t.setTextField(document.getElementById("gauge-text"))), $("#chart_gauge_02").length)var n = document.getElementById("chart_gauge_02"), o = new Gauge(n).setOptions(e);
...
function init_cropper() {
    if ("undefined" != typeof $.fn.cropper) {
        ...
        var e = $("#image"), a = $("#download"), t = $("#dataX"), n = $("#dataY"), o = $("#dataHeight"), i = $("#dataWidth"), r = $("#dataRotate"), l = $("#dataScaleX"), s = $("#dataScaleY"), c = {
            aspectRatio: 16 / 9,
            preview: ".img-preview",
            crop: function (e) {
...
function init_CustomNotification() {
    if (console.log("run_customtabs"), CustomTabs = function (e) {
            $(".tabbed_notifications > div").hide(), $(".tabbed_notifications > div:first-of-type").show(), $("#custom_notifications").removeClass("dsp_none"), $(".notifications a").click(function (e) {
                e.preventDefault();
                var a = $(this), t = "#" + a.parents(".notifications").data("tabbed_notifications"), n = a.closest("li").siblings().children("a"), o = a.attr("href");
...
function init_charts() {
    if (console.log("run_charts  typeof [" + typeof Chart + "]"), "undefined" != typeof Chart) {
        if ($("#mybarChart").length) {
            ...
            color_list=["#26B99A","#03586A","#455C73", "#9B59B6", "#BDC3C7", "#26B99A", "#3498DB"]
            ...
            for (var i = 0; i < bar_items.length; i++) {
                if (bar_items[i][5] > 0) {
                    dict.push({
                        ...
                        data: [bar_items[i][2], bar_items[i][4], bar_items[i][1], bar_items[i][3], bar_items[i][5]]
                    })
                }
            }
            console.log(color_list[0][1]);
            new Chart(e, {
                type: "bar",
                data: {
                    labels: ["SELECT", "UPDATE ", "INSERT ", "DELETE ", "TOTAL"],
                    datasets: dict
                },
...
function init_calendar() {
    if ("undefined" != typeof $.fn.fullCalendar) {
        ...
        var e, a, t = new Date, n = t.getDate(), o = t.getMonth(), i = t.getFullYear(), r = $("#calendar").fullCalendar({
            header: {
            ...
            events: [{title: "تمام روز رویداد", start: new Date(i, o, 1)}, {
                ...
                allDay: !1
            }, {title: "کلیک برای گوگل", start: new Date(i, o, 28), end: new Date(i, o, 29), url: "http://google.com/"}]
        })
    }
}
